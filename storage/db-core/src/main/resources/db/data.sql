...
VALUES ('두정역 주변 ㄱㄱ', '갑시다~', '2024-08-31T23:15:20', '충청남도 천안시 서북구 1공단3길 1', '충남 천안시 서북구 성정동 1486',
...
INSERT INTO party (title, explanation, departure_time, origin, destination,
                   ...
                   origin_location, destination_location,
                   max_participants, views, created_at, updated_at)
VALUES ('나는야 준석이 >.<', '갑시다~', '2024-08-31T23:15:20', '충남 천안시 서북구 두정동 1801', '충남 천안시 서북구 성정동 1429',
...
INSERT INTO party (title, explanation, departure_time, origin, destination,
                   ...
                   origin_location, destination_location,
                   max_participants, views, created_at, updated_at)
VALUES ('성정동에서 한성3차필하우스 ㄱ', '갑시다~', '2024-08-31T23:15:20', '충남 천안시 서북구 성정동 1171-1', '한성3차필하우스아파트 105동',
...
INSERT INTO party (title, explanation, departure_time, origin, destination,
                   ...
                   origin_location, destination_location,
                   max_participants, views, created_at, updated_at)
VALUES ('진영렌트빌에서 성정동', '갑시다~', '2024-08-31T23:15:20', '진영렌트빌', '충남 천안시 서북구 성정동 747', '충청남도 천안시 서북구 서부19길 41-4',
